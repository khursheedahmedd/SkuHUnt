...
const ThreeCardSection: React.FC = () => {
  return (
    <section className="w-full px-4 py-8 flex flex-col items-center gap-8">
      {/* Top Heading */}
      <p className="text-center text-3xl sm:text-3xl md:text-4xl lg:text-5xl space-x-2 font-extrabold leading-snug text-gray-800 py-8">
      ...
      <div className="w-full flex flex-wrap justify-center gap-16">
        {/* Card 1 */}
        <div className="flex flex-col space-y-8 w-full sm:w-[300px] h-[24rem] p-6 bg-neutral-100 rounded-lg border border-indigo-400 shadow-md hover:shadow-lg transition-shadow">
        ...
        {/* Card 2 */}
        <div className="flex flex-col space-y-8 w-full sm:w-[300px] h-[24rem] p-6 bg-neutral-100 rounded-lg border border-indigo-300 shadow-md hover:shadow-lg transition-shadow">
