...
const Video: React.FC = () => {
  return (
    <div
      className="flex flex-col md:flex-row items-center p-12 md:space-x-12 lg:p-[6rem] justify-between w-full h-auto bg-gradient-to-l from-indigo-300 via-white to-white"
      style={{
    ...
    >
      ...
      <div className="flex flex-col justify-center gap-6 gap-x-8 w-full md:w-1/2  md:text-left text-center">
        ...
        <div className="flex flex-col items-center md:items-start space-y-2 w-full md:w-auto">
          <a
            ...
            className=" text-indigo-400 border border-indigo-600 py-3 px-6 rounded-full shadow-md hover:bg-indigo-50 transition duration-300 w-auto md:w-auto"
          >
            Learn More
          </a>
        </div>
      ...
      <div className="flex justify-center md:justify-end items-center w-full md:w-1/2 mt-6 md:mt-0">
        <video
          ...
          className="w-full h-auto ject-cover rounded-lg"
