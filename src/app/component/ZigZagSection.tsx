          ...
          >
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <a
                ...
                className="bg-indigo-100 text-indigo-600 border border-indigo-600 py-2 md:px-8 sm:py-3 px-4 sm:px-6 rounded-full shadow-md hover:bg-indigo-50 transition duration-300 w-full"
              >
                Learn More
              </a>
            </div>
