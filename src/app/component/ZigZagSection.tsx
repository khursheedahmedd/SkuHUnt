        ...
        <React.Fragment key={index}>
          ...
          >
            ...
            <div className="flex-1 text-center md:text-left">
              <p
                className="text-3xl sm:text-3xl lg:text-7xl font-satoshi font-medium text-gray-700 mb-4 md:mt-10 mt-4"
                style={
                  {
                    // fontFamily: "Satoshi, sans-serif",
                    // fontSize: "50px",
          ...
          {index === 2 && (
            <div
              className="flex flex-col items-center py-16 px-8 justify-center mt-12 bg-indigo-600 rounded-3xl shadow-lg w-full  sm:px-2 md:px-8 lg:px-12 md:mb-[6rem] mb-2"
              style={{
                height: "auto",
                // padding: "60px",
                textAlign: "center",
